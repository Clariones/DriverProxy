...
public class CmdSetProxyData extends BaseManageCmd implements IRestCommandHandler {
	...
	public IRestResponse handleCommand(IRestRequest restRequest) {
		...
		case DATE_TYPE_LAYOUT:
			handleGetLayout(restRequest, result, getOverwriteParam(restRequest));
			break;
		case DATE_TYPE_PROFILE:
			handleGetProfile(restRequest, result, getOverwriteParam(restRequest));
			break;
		case DATE_TYPE_DEVICE_CFG:
			handleGetDeviceCfg(restRequest, result, getOverwriteParam(restRequest));
			break;
		default:
	...
	protected void handleGetDeviceCfg(IRestRequest restRequest, IRestResponse result, boolean overWriteAll) {
	...
	protected void handleGetProfile(IRestRequest restRequest, IRestResponse result, boolean overWriteAll) {
	...
	protected void handleGetLayout(IRestRequest restRequest, IRestResponse result, boolean overWriteAll) {
