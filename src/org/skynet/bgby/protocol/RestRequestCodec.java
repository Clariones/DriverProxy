...
public class RestRequestCodec {
	...
	public IRestRequest getRequest(IHTTPSession session) {
		...
		handleBody(body, params);
		req.setParams(params);

		return req;
	}

	private void handleBody(HashMap<String, String> body, Map<String, String> params) {
		if (body.isEmpty()) {
			return;
		}
		...
		DriverUtils.log(Level.FINE, TAG, "Unrecognized body type: " + body.keySet());
	}
